...
if __name__ == '__main__':
    ...
    for i in gammas:
        start = time.time()
        PI = mdptoolbox.mdp.PolicyIterationModified(transitions=P, reward=R, gamma=i, epsilon=0.01, max_iter=10000)
    ...
    # plt.show()
    plt.savefig("Assignment4/ForestCharts/PI Gammas and Scores.png")
    ...
    # plt.show()
    plt.savefig("Assignment4/ForestCharts/PI Rewards and Iterations.png")
    ...
    # PI = mdptoolbox.mdp.PolicyIterationModified(transitions=P, reward=R, gamma=.99, epsilon=0.01, max_iter=10000)
    # # PI.setVerbose()
    # stats = PI.run()
    # optimal_policy = PI.policy
    # steps_list = []
